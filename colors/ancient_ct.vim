...
hi StatusLine   ctermfg=grey ctermbg=0
"hi StatusLineNC guifg=#cccccc guibg=#aaaaaa ctermfg=188   ctermbg=8
hi StatusLineNC ctermfg=grey ctermbg=0
"hi VertSplit    guifg=#cccccc guibg=#cccccc ctermfg=188   ctermbg=188
hi VertSplit    ctermfg=grey ctermbg=grey

" ColorColumn color
"hi ColorColumn ctermbg=lightgrey ctermfg=NONE
hi ColorColumn ctermbg=230 ctermfg=NONE

" Cursor lines, notably used by ctrlp plugin
hi CursorLine cterm=NONE ctermfg=NONE ctermbg=lightgrey
set cursorline
...
hi SpellCap  cterm=underline ctermbg=NONE ctermfg=25
